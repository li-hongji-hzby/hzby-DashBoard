...
import { Col, Row, Container, Card, Badge, ButtonGroup, Button, Table, Image, DropdownButton, Dropdown } from 'react-bootstrap'
...
const downsampleList=[
  ["10秒","10s"],["1分钟","1m"],["5分钟","5m"],["30分钟","30m"],["1小时","1h"],["6小时","6h"],["1天","1d"],["1周","1w"],["1个月","1m"]
]
          ...
          <Card className="w-100 self-card" style={{"boxShadow":"none"}}>
            ...
            <Card.Body className=" self-card-content">
                {Object.keys(this.state.machineKindList).map((key, index) => 
                  <Button className={style.machineBtn + " mr-2"} key={index} variant="info"
        ...
        <Row className="w-100 top-divider mr-0 ml-0">
          <Card className="w-100 self-card" style={{"boxShadow":"none"}}>
            <Card.Header className="d-flex justify-content-start align-items-center self-card-header">
              ...
              <Badge className="ml-5 mr-2 p-2" variant="primary">
                  选择时间
              </Badge>
              <DatePicker
                // selected={startDate}
              ...
              <DatePicker
                ...
                dateFormat="yyyy/MM/dd hh:mm"
              />
              <DropdownButton size="sm" className="ml-2" as={ButtonGroup} title={this.state.downsampleZh}>
              ...
              <Button className={style.machineBtn + " mr-2 ml-2"}
