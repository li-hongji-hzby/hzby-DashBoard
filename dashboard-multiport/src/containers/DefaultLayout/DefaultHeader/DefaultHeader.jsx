  ...
  render() {
    return (
      <Row lg={12} md={12} sm={12} className="h-56 m-0 d-flex justify-content-center align-items-center">
        <div className="logo-box d-flex justify-content-center align-items-center dark-black">
          Header
        </div>
        <Col className="h-56 d-flex justify-content-between pt-2 pb-2 pl-3 pr-3 self-border-bottom-dark">
          <Button className="sidebar-btn" variant="dark" size="sm" onClick={()=>this.props.sideBarVisible()}>
          ...
          <div className="mobile-logo-box dark-black">
            Header
          </div>
