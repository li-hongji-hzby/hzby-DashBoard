                    ...
                    <Row>
                      <Col sm="6">
                        <div className="callout callout-info">
                          ...
                          <div className="chart-wrapper">
                            <Line data={makeSparkLineData(0, brandPrimary)} options={this.state.sparklineChartOpts} width={100} height={30} />
                          </div>
                        </div>
                      </Col>
                      <Col sm="6">
                        <div className="callout callout-danger">
                          ...
                          <div className="chart-wrapper">
                            <Line data={makeSparkLineData(1, brandDanger)} options={this.state.sparklineChartOpts} width={100} height={30} />
                          </div>
                        </div>
                      </Col>
                    </Row>
